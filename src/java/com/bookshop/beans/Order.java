...
public class Order {
    ...
    public Order (Long addressId, Long addressAddId, Long packageId , Long customerId, 
            Date orderDate, int orderInvoice, String orderTerms, String orderInstruct, 
            BigDecimal orderTotal, String customerIp ){
